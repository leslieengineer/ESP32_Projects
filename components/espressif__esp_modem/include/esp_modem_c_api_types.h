...
esp_err_t esp_modem_sync(esp_modem_dce_t *dce_wrap);

esp_err_t esp_modem_get_signal_quality(esp_modem_dce_t *dce_wrap, int *rssi, int *ber);

esp_err_t esp_modem_get_operator_name(esp_modem_dce_t *dce_wrap, char *p_name, int *p_act);

esp_err_t esp_modem_get_module_name(esp_modem_dce_t *dce_wrap, char *p_name);

esp_err_t esp_modem_get_imei(esp_modem_dce_t *dce_wrap, char *p_imei);

esp_err_t esp_modem_get_imsi(esp_modem_dce_t *dce_wrap, char *p_imsi);
